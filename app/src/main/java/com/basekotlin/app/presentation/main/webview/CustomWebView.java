...
public class CustomWebView extends WebView {
    ...
    protected final List<String> mShouldRedirectUrls = new LinkedList<>();
    ...
    public void addShouldRedirectUrl(String url) {
        mShouldRedirectUrls.add(url);
    }

    public void addShouldRedirectUrls(Collection<? extends String> collection) {
        mShouldRedirectUrls.addAll(collection);
    }

    public List<String> getShouldRedirectUrls() {
        return mShouldRedirectUrls;
    }

    public void removeShouldRedirectUrl(String url) {
        mShouldRedirectUrls.remove(url);
    }

    public void clearShouldRedirectUrl() {
                ...
                setWebChromeClient(new WebChromeClient() {
                    ...
                    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]>
                        ...
                        if (mCustomWebChromeClient != null) {
                            boolean handled = mCustomWebChromeClient.onShowFileChooser(webView, filePathCallback, fileChooserParams);
                            if (handled) {
                                return true;
                            }
                        }
                    ...
                    @Override
                    public void onReachedMaxAppCacheSize(long requiredStorage, long quota, QuotaUpdater
                            quotaUpdater) {
                        if (mCustomWebChromeClient != null) {
    ...
    protected boolean isUrlAllowed(final String url) {
        ...
        for (String shouldRedirectUrl : mShouldRedirectUrls) {
